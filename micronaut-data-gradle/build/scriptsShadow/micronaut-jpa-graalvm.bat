...
set CLASSPATH=%APP_HOME%\lib\micronaut-jpa-graalvm-0.1-all.jar

@rem Execute micronaut-jpa-graalvm
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MICRONAUT_JPA_GRAALVM_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MICRONAUT_JPA_GRAALVM_EXIT_CONSOLE%" exit 1
exit /b 1
